  ...
  private heroes: Hero[] = [
    {
      nombre: 'Aquaman',
      bio:
        'El poder más reconocido de Aquaman es la capacidad telepática para comunicarse con la ' +
    ...
    },
    {
      nombre: 'Batman',
      bio:
        'Los rasgos principales de Batman se resumen en «destreza física, habilidades deductivas ' +
        'y obsesión». La mayor parte de las características básicas de los cómics han variado por ' +
    ...
    },
    {
      ...
      bio:
        ...
        'de su ceguera, puede \'ver\' a través de un \'sexto sentido\' que le sirve como un radar ' +
